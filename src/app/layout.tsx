...
export const metadata: Metadata = {
  ...
  // Real `src/app/favicon.ico` (PNG-in-ICO from `scripts/build-favicon-ico.mjs`) + explicit links
  // so production never falls back to Next’s default triangle. `public/favicon.png` for OG.
  icons: {
    icon: [
